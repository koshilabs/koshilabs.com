        ...
        <Card className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md border border-white/10 shadow-lg rounded-2xl overflow-hidden h-full">
            ...
            <CardHeader className="pt-8 pb-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <CardTitle className="text-white text-xl font-semibold">{testimonial.name}</CardTitle>
                        <CardDescription className="text-blue-300 text-sm">{testimonial.company}</CardDescription>
                    </div>
                </div>
            </CardHeader>
